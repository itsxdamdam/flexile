        ...
        {options.map((option) => {
          ...
          return (
            ...
            >
              ...
              >
                <RadioGroupPrimitive.Indicator className="relative flex size-full items-center justify-center after:block after:size-2 after:rounded-full after:bg-blue-500" />
              </RadioGroupPrimitive.Item>
